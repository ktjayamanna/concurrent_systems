...
The full implementation is available at \url{https://github.com/ktjayamanna/speculative_threading_for_low_latency_agentic_workflows}.
The SAGE++ contribution resides in \texttt{src/Backend/src/sage\_plus\_plus}.
Benchmarks can be reproduced from \texttt{src/benchmark}.
